...
const Navbar = () => {
  ...
  <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
    <NavLink className=' nav-item flex-col flex items-center gap-1' to='/'><p>HOME</p></NavLink>
    <NavLink className=' nav-item flex-col flex items-center gap-1' to='/collection'><p>COLLECTION</p></NavLink>
    <NavLink className=' nav-item flex-col flex items-center gap-1' to='/about'><p>ABOUT</p></NavLink>
    <NavLink className=' nav-item flex-col flex items-center gap-1' to='/contact'><p>CONTACT</p></NavLink>
  </ul>
